        ...
        <form class="form-horizontal" id="addMedicine">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" name="saleMenuId" type="text" placeholder="20190411001"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">药品ID</label>
                    <div class="col-sm-4">
                        <input  class="form-control" name="storeMedicineId" type="20190102011"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">售卖价格</label>
                    <div class="col-sm-4">
                        <input class="form-control" name="salePrice" type="text" placeholder="9.00"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">会员价格</label>
                    <div class="col-sm-4">
                        <input class="form-control" name="saleVipPrice" type="text" placeholder="8.00"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">数量</label>
                    <div class="col-sm-4">
                        <input class="form-control" name="amount" type="text" placeholder="2"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">总价</label>
                    <div class="col-sm-4">
                        <input class="form-control" name="totalPrice" type="18"/>
                    </div>
                </div>
            </fieldset>
        </form>
...
/*        $("#btn_add").click(function() {
    ...
    $('#search_btn').click(function(){
        $('#mytab').bootstrapTable('refresh', {url: '/sale/hh'});
    })
