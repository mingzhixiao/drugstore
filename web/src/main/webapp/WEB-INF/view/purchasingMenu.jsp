        ...
        <form class="form-horizontal" id="addPurchasingMenu">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" name="employeeId" type="text" placeholder="张三"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">供应商编号</label>
                    <div class="col-sm-4">
                        <input  class="form-control" name="supplierId" type="text"/>
                    </div>
                </div>
                <div class="form-group">
...
/*        $("#btn_add").click(function() {
    ...
    $('#search_btn').click(function(){
        $('#mytab').bootstrapTable('refresh', {url: '/purchasingMenu/hh'});
    })
...
/*            onClickCell: function(field, value, row, $element) {
        ...
        $('#addPurchasingMenu').bootstrapValidator({
            feedbackIcons: {
