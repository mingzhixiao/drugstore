        ...
        <form class="form-horizontal" id="addSaleMenu">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" name="employeeId" type="text" placeholder="9527"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">顾客编号</label>
                    <div class="col-sm-4">
                        <input  class="form-control" name="customerId" type="text" placeholder="20190101001"/>
                    </div>
                </div>
                <div class="form-group">
...
/*        $("#btn_add").click(function() {
    ...
    $('#search_btn').click(function(){
        $('#mytab').bootstrapTable('refresh', {url: '/saleMenu/all'});
    })
...
/*            onClickCell: function(field, value, row, $element) {
        ...
        $('#addSaleMenu').bootstrapValidator({
            feedbackIcons: {
